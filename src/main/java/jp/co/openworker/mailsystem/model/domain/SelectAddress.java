...
public class SelectAddress {
	...
	public SelectAddress(SelectForm f) {
		...
		userId2 = f.getUserId2();
		companyName2 = f.getCompanyName2();
		corporation2 = f.getCorporation2();
		staffName2 = f.getStaffName2();
		staffMail2 = f.getStaffMail2();
		userId3 = f.getUserId3();
		companyName3 = f.getCompanyName3();
		corporation3 = f.getCorporation3();
		staffName3 = f.getStaffName3();
		staffMail3 = f.getStaffMail3();
		userId4 = f.getUserId4();
		companyName4 = f.getCompanyName4();
		corporation4 = f.getCorporation4();
		staffName4 = f.getStaffName4();
		staffMail4 = f.getStaffMail4();
		userId5 = f.getUserId5();
		companyName5 = f.getCompanyName5();
		corporation5 = f.getCorporation5();
		staffName5 = f.getStaffName5();
		staffMail5 = f.getStaffMail5();
		userId6 = f.getUserId6();
		companyName6 = f.getCompanyName6();
		corporation6 = f.getCorporation6();
		staffName6 = f.getStaffName6();
		staffMail6 = f.getStaffMail6();
		userId7 = f.getUserId7();
		companyName7 = f.getCompanyName7();
		corporation7 = f.getCorporation7();
		staffName7 = f.getStaffName7();
		staffMail7 = f.getStaffMail7();
		userId8 = f.getUserId8();
		companyName8 = f.getCompanyName8();
		corporation8 = f.getCorporation8();
		staffName8 = f.getStaffName8();
		staffMail8 = f.getStaffMail8();
		userId9 = f.getUserId9();
		companyName9 = f.getCompanyName9();
		corporation9 = f.getCorporation9();
		staffName9 = f.getStaffName9();
		staffMail9 = f.getStaffMail9();
		userId10 = f.getUserId10();
		companyName10 = f.getCompanyName10();
		corporation10 = f.getCorporation10();
